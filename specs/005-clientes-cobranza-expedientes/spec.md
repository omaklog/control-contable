...
- **FR-023**: El sistema DEBE permitir registrar uno o más Contactos por Cliente, cada uno con nombre y teléfono obligatorios y correo electrónico opcional.
...
- **Contacto**: Persona de contacto de un Cliente. Atributos: cliente (relación), nombre, teléfono, correo (opcional), trazabilidad. Relación N a 1 con Cliente (un Cliente puede tener varios Contactos).
