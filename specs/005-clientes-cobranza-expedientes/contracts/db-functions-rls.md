...
| `business_audit_log`                                 | Solo Administrador (capacidad `view_auth_audit_log` o equivalente de negocio)                                                  | Solo vía trigger (`security definer`), nunca directo desde un rol de aplicación                                                                                    | Bloqueado siempre (append-only)                                                |
