...
1. Iniciar sesión con una cuenta Administrador y con una cuenta Contador/Auxiliar, y comparar las entradas de menú visibles para cada una.
   - **Esperado** (según la decisión de alcance de `spec.md`): mientras ningún módulo de negocio tenga una capacidad propia, las entradas visibles son las mismas para los 3 roles, todas marcadas "próximamente" y deshabilitadas (Acceptance Scenario 1, FR-006/FR-007).
